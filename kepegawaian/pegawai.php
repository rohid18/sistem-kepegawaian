...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            echo "<table><tr><th>ID</th><th>Nama</th><th>Alamat</th><th>No. Telepon</th><th>Jabatan</th><th>Aksi</th></tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td>{$jabatan_name}</td>
                    <td>
                        <a href='pegawai.php?edit={$row['id_pegawai']}'>Edit</a> | 
                        <a href='pegawai.php?delete={$row['id_pegawai']}' onclick='return confirm(\"Are you sure you want to delete this record?\");'>Delete</a>
                    </td>
                    </tr>";
            }
            echo "</table>";
